...
// Am extras conținutul principal într-o componentă separată 
// pentru a putea folosi hook-ul `useLocation`
function AppContent() {
    const location = useLocation(); // Hook nou care ne spune mereu pe ce pagină suntem
    ...
    }, [location.pathname]); // Se rulează de fiecare dată când se schimbă adresa
